<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="维护编号" prop="weihubianhao">
					<el-input v-model="ruleForm.weihubianhao" placeholder="维护编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.weihubianhao" label="维护编号" prop="weihubianhao">
					<el-input v-model="ruleForm.weihubianhao" placeholder="维护编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="维护时间" prop="weihushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.weihushijian" label="维护时间" prop="weihushijian">
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='weihubianhao'){
							this.ruleForm.weihubianhao = obj[o];
							this.ro.weihubianhao = true;
							continue;
						}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chanpinweihu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chanpinweihuCrossAddOrUpdateFlag = false;
						 this.parent.search();
