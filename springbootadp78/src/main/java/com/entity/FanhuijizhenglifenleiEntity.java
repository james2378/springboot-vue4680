 ...
 */
@TableName("fanhuijizhenglifenlei")
public class FanhuijizhenglifenleiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FanhuijizhenglifenleiEntity() {
		
	}
	
	public FanhuijizhenglifenleiEntity(T t) {
		try {
	 ...
	 * 设置：分类时间
	 */
	public void setFenleishijian(Date fenleishijian) {
		this.fenleishijian = fenleishijian;
	}
	/**
	 * 获取：分类时间
	 */
	public Date getFenleishijian() {
		return fenleishijian;
	}
	/**
	 * 设置：人员账号
	 */
