...
public class FanhuijizhuangxiangfanchangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FanhuijizhuangxiangfanchangEntity() {
		
	}
	
	public FanhuijizhuangxiangfanchangEntity(T t) {
		try {
	...
	private String fanchangbianhao;
	 ...
	 * 设置：返厂编号
	 */
	public void setFanchangbianhao(String fanchangbianhao) {
		this.fanchangbianhao = fanchangbianhao;
	}
	/**
	 * 获取：返厂编号
	 */
	public String getFanchangbianhao() {
		return fanchangbianhao;
	}
	/**
	 * 设置：产品名称
	 */
