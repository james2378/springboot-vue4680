 ...
 */
@TableName("kehuquhui")
public class KehuquhuiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public KehuquhuiEntity() {
		
	}
	
	public KehuquhuiEntity(T t) {
		try {
	...
	private String chanpinzhuangtai;
	 ...
	 * 设置：产品状态
	 */
	public void setChanpinzhuangtai(String chanpinzhuangtai) {
		this.chanpinzhuangtai = chanpinzhuangtai;
	}
	/**
	 * 获取：产品状态
	 */
	public String getChanpinzhuangtai() {
		return chanpinzhuangtai;
	}
	/**
	 * 设置：取回时间
	 */
	public void setQuhuishijian(Date quhuishijian) {
		this.quhuishijian = quhuishijian;
	}
	/**
	 * 获取：取回时间
	 */
	public Date getQuhuishijian() {
		return quhuishijian;
	}
	/**
	 * 设置：人员账号
