...
public class FanhuijizhuangxiangfanhuiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FanhuijizhuangxiangfanhuiEntity() {
		
	}
	
	public FanhuijizhuangxiangfanhuiEntity(T t) {
		try {
