...
public class KehushouhuoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public KehushouhuoEntity() {
		
	}
	
	public KehushouhuoEntity(T t) {
		try {
	 ...
	 * 设置：邮寄状态
	 */
	public void setYoujizhuangtai(String youjizhuangtai) {
		this.youjizhuangtai = youjizhuangtai;
	}
	/**
	 * 获取：邮寄状态
	 */
	public String getYoujizhuangtai() {
		return youjizhuangtai;
	}
	/**
	 * 设置：收货时间
	 */
